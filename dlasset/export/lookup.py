...
from .functions import (
    ...
    export_image_material, export_image_story, export_mono_behaviour, export_sprite_ui,
)
...
EXPORT_FUNCTIONS: dict[ExportType, ExportFunction] = {
    ...
    "Texture2D-Material": export_image_material,
...
TYPES_TO_INCLUDE: dict[ExportType, tuple[UnityType, ...]] = {
    ...
    "Texture2D-Material": ("Texture2D", "Material", "MonoBehaviour"),
